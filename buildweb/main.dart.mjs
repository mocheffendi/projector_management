...
_2077: d => d.toExponential(),
_2078: (d, f) => d.toExponential(f),
...
_2138: (a, s, e) => a.splice(s, e),
_2140: a => a.length,
_2141: (a, l) => a.length = l,
_2142: (a, i) => a[i],
_2143: (a, i, v) => a[i] = v,
...
_2187: x0 => new Uint8Array(x0),
_2188: () => globalThis.crypto,
...
_2209: () => Date.now(),
_2211: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_2216: x0 => globalThis.URL.createObjectURL(x0),
_2218: x0 => ({type: x0}),
_2219: (x0,x1) => new Blob(x0,x1),
_2220: () => new XMLHttpRequest(),
_2221: x0 => x0.send(),
_2223: () => new FileReader(),
_2224: (x0,x1) => x0.readAsArrayBuffer(x1),
...
_2243: x0 => x0.trustedTypes,
_2245: (x0,x1) => x0.text = x1,
_2262: (s, m) => {
          try {
...
_2264: (x0,x1) => x0.test(x1),
_2265: (x0,x1) => x0.exec(x1),
_2266: (x0,x1) => x0.exec(x1),
_2267: x0 => x0.pop(),
_2271: (x0,x1,x2) => x0[x1] = x2,
_2273: o => o === undefined,
_2274: o => typeof o === 'boolean',
_2275: o => typeof o === 'number',
_2277: o => typeof o === 'string',
_2280: o => o instanceof Int8Array,
_2281: o => o instanceof Uint8Array,
_2282: o => o instanceof Uint8ClampedArray,
_2283: o => o instanceof Int16Array,
_2284: o => o instanceof Uint16Array,
_2285: o => o instanceof Int32Array,
_2286: o => o instanceof Uint32Array,
_2287: o => o instanceof Float32Array,
_2288: o => o instanceof Float64Array,
_2289: o => o instanceof ArrayBuffer,
_2290: o => o instanceof DataView,
_2291: o => o instanceof Array,
_2292: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_2294: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_2295: o => o instanceof RegExp,
_2296: (l, r) => l === r,
_2297: o => o,
_2298: o => o,
_2299: o => o,
...
_2301: o => o.length,
_2304: (o, i) => o[i],
_2305: f => f.dartFunction,
_2306: l => arrayFromDartList(Int8Array, l),
_2307: (data, length) => {
...
_2308: l => arrayFromDartList(Uint8ClampedArray, l),
_2309: l => arrayFromDartList(Int16Array, l),
_2310: l => arrayFromDartList(Uint16Array, l),
_2311: l => arrayFromDartList(Int32Array, l),
_2312: l => arrayFromDartList(Uint32Array, l),
_2313: l => arrayFromDartList(Float32Array, l),
_2314: l => arrayFromDartList(Float64Array, l),
_2315: (data, length) => {
...
_2316: l => arrayFromDartList(Array, l),
_2317:       (s, length) => {
        if (length == 0) return '';
...
_2326: (o, p) => o[p],
_2327: (o, p, v) => o[p] = v,
_2328: (o, m, a) => o[m].apply(o, a),
_2330: o => String(o),
_2331: (p, s, f) => p.then(s, f),
_2332: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_2475: (x0,x1) => x0.responseType = x1,
_2476: x0 => x0.response,
_2540: (x0,x1) => x0.draggable = x1,
_2556: x0 => x0.style,
_3488: (x0,x1) => x0.accept = x1,
_3502: x0 => x0.files,
_3528: (x0,x1) => x0.multiple = x1,
_3546: (x0,x1) => x0.type = x1,
_3803: (x0,x1) => x0.type = x1,
_3811: (x0,x1) => x0.crossOrigin = x1,
_3813: (x0,x1) => x0.text = x1,
_4288: () => globalThis.window,
_4353: x0 => x0.navigator,
_4615: x0 => x0.trustedTypes,
_4743: x0 => x0.vendor,
_6946: x0 => x0.type,
_7057: x0 => x0.firstChild,
_7068: () => globalThis.document,
_7163: x0 => x0.head,
_7512: (x0,x1) => x0.id = x1,
_7539: x0 => x0.children,
_9081: x0 => x0.size,
_9088: x0 => x0.name,
_9095: x0 => x0.length,
_9106: x0 => x0.result,
_12055: (x0,x1) => x0.display = x1,
_14014: () => globalThis.console,
_14045: x0 => x0.name,
_14046: x0 => x0.message,
_14047: x0 => x0.code
    };
